/*
  This data was pulled from the priaid-symptom-checker-v1 API 
  (the same API used to check symptoms and get a diagnosis).

  It's small enough to save locally and makes it much easier to look up symptom ids,
  which are the required input for processing a diagnosis.
*/
